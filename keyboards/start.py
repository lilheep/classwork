...
kb_start_anime = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='Этот замечательный мир! 3',url='https://animego.org/anime/etot-zamechatelnyy-mir-3-2538', callback_data='Animego')],
        [InlineKeyboardButton(text='Назад', callback_data='back')]])
